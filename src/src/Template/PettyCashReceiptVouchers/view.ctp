...
<table width="100%" class="divHeader">
		<tr>
			...
			<?= h($pettyCashReceiptVoucher->company->mobile_no) ?></span>
			</td>
		</tr>
		<tr>
			<td colspan="3">
	...
	<table width="100%" class="table_rows ">
		<tr>
			...
			<?php 
			echo $this->Html->Image('/signatures/'.$pettyCashReceiptVoucher->creator->signature,['height'=>'50px','style'=>'height:50px;']); 
			?></br>
			</hr>
			<span><b>Prepared By</b></span><br/>
			<span><?= h($pettyCashReceiptVoucher->creator->name) ?></span><br/>
			</td>
		</tr>
	</table>

...
use App\Model\Table\NppaymentRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\NppaymentRowsTable Test Case
 */
class NppaymentRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\NppaymentRowsTable
     */
    public $NppaymentRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('NppaymentRows') ? [] : ['className' => 'App\Model\Table\NppaymentRowsTable'];
        $this->NppaymentRows = TableRegistry::get('NppaymentRows', $config);
    }

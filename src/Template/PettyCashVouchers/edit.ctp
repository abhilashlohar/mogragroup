...
$(document).ready(function() {
    ...
    function delete_all_ref_no(sel){
        ...
        url=url+'/'+old_received_from_id+'/'+<?php echo $pettycashvoucher->id; ?>,
        $.ajax({
            url: url,
            type: 'GET',
        }).done(function(response) {
    ...
    function delete_one_ref_no(sel){
        ...
        url=url+'?old_received_from_id='+old_received_from_id+'&petty_cash_voucher_id=<?php echo $pettycashvoucher->id; ?>&old_ref='+old_ref+'&old_ref_type='+old_ref_type,
        $.ajax({
            url: url,
            type: 'GET',
        }).done(function(response) {

...
use App\Model\Table\NppaymentsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\NppaymentsTable Test Case
 */
class NppaymentsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\NppaymentsTable
     */
    public $Nppayments;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Nppayments') ? [] : ['className' => 'App\Model\Table\NppaymentsTable'];
        $this->Nppayments = TableRegistry::get('Nppayments', $config);
    }
